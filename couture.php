...
<body>
    ...
    <form action="couture.php" method="get">
        ...
        <fieldset>
            ...
            $qry_count = "SELECT word FROM words where category like 'couture'";
            ...
            for ($i = 1; $i <= $count; $i++) {
                ...
                $query = "SELECT word FROM words where category like 'couture' ORDER BY RAND() limit 1  ";
                $result = mysqli_query($conn, $query);
                $row = mysqli_fetch_assoc($result);

                // Shuffle the answer choices
                $choices = array($row['word']);
                $query = "SELECT word FROM words where category like 'couture' and word != '{$row['word']}' ORDER BY RAND() LIMIT 2";
                $result = mysqli_query($conn, $query);
